...
import { billiardApi, orderApi } from '../../shared/lib/api'
...
import { formatCurrency, formatPlayDuration, formatTimeOnly, durationSecondsBetween } from '../../shared/lib/utils'
import { Button } from '../../shared/components/Button'
import { Card, CardContent } from '../../shared/components/Card'
import { Badge } from '../../shared/components/Badge'
import { LoadingPage } from '../../shared/components/Loading'
import { ChevronLeft, Plus, Minus, Trash2, ShoppingBag, X, Search, Coffee, Sparkles, PanelRightClose, PanelRightOpen } from 'lucide-react'
                ...
                return (
                  ...
                  >
                    ...
                    <div className="h-36 sm:h-40 bg-gradient-to-br from-brand-100/60 to-brand-50 dark:from-brand-800/60 dark:to-brand-900 relative overflow-hidden flex items-center justify-center">
                      ...
                      {/* Options Tag */}
                      {hasCustomOptions && (
                        <span className="absolute top-2.5 left-2.5 bg-brand-600/90 text-white backdrop-blur-md px-2 py-0.5 rounded-lg text-[9px] uppercase font-extrabold tracking-wider shadow-sm">
                          Tùy chọn
                        </span>
                      )}
      ...
      `}>
        ...
        <div className="p-4 bg-brand-50/50 border-t border-brand-100 dark:border-brand-700 space-y-3">
          ...
          {order && (
            <Button
              variant="outline"
              className="w-full h-11 border-brand-300 dark:border-brand-700 text-brand-800 dark:text-brand-200 hover:bg-brand-100 dark:hover:bg-brand-800 font-bold shadow-sm"
            ...
            >
              {checkout.isPending
                ? 'Đang xử lý...'
                : payTiming === 'BEFORE'
                  ? 'Trả bàn (Set bàn trống)'
                  : 'Thanh toán đơn hiện tại & trả bàn'}
            </Button>
          )}
        </div>
      </div>
